...
export default function Contact() {
    ...
    return (
        <>
            <div className="contactContainer flex flex-col items-center justify-center bg-white rounded-xl mb-15 overflow-hidden">
                ...
                <div className="flex justify-center items-center w-50 w-fit">
                    ...
                    <div className="flex flex-col justify-center gap-5 items-left m-10 w-auto p-10" >
                        ...
                        <div className='flex items-center'>
                            ...
                            <h1 style={{ fontFamily: 'Cambo' }}><a href="https://www.linkedin.com/in/jeramy-daradal-a281b1366">Jeramy Daradal</a></h1>
                        </div>
                        <div className='flex items-center'>
                            <PhoneAndroidIcon fontSize='large'/>
                            <h1 style={{ fontFamily: 'Cambo' }}>+63-9622683998/ +63-9171387916</h1>
                        </div>
                    </div>
                </div>
            </div>
